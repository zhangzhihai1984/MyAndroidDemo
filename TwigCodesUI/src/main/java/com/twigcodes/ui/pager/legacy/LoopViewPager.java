package com.twigcodes.ui.pager.legacy;
...
public class LoopViewPager extends ViewPager {
    ...
    public LoopViewPager(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LoopViewPager, 0, 0);

        mIsAutoPageEnabled = a.getBoolean(R.styleable.LoopViewPagerLegacy_pager_autopage_enabled, false);
        mAutoPageInterval = a.getInt(R.styleable.LoopViewPagerLegacy_pager_autopage_interval, DEFAULT_AUTO_PAGER_INTERVAL);
        mIsCacheEnabled = a.getBoolean(R.styleable.LoopViewPagerLegacy_pager_cache_enabled, false);
